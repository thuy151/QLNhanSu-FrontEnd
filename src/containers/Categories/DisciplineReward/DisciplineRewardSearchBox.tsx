...
function DisciplineRewardSearchBox(props: any) {
                    ...
                    >
                        <Row gutter={30}>
                            <Col span={12}>
                                <CommonFormItem
                                    name="username"
                                    label={t('accountPage.searchBox.label.username')}
                                    placeholder={t('accountPage.searchBox.placeholder.username') as string}
                                />
                            </Col>
                            <Col span={12}>
                                <CommonFormItem
                                    name="name"
                                    label={t('accountPage.searchBox.label.name')}
                                    placeholder={t('accountPage.searchBox.placeholder.name') as string}
                                />
                            </Col>
                        </Row>
                        <Row gutter={30}>
                        ...
                        <Row gutter={30}>
                            <Col span={12}>
                                <CommonFormItem
                                    name="status"
                                    label={t('accountPage.searchBox.label.status')}
                                    placeholder={t('accountPage.searchBox.placeholder.status') as string}
...
export default DisciplineRewardSearchBox;
